...
func main() {
	...
	route.HandleFunc("/submit_halaman_edit/{index}", submitHalamanEdit).Methods("POST")
...
func home(w http.ResponseWriter, r *http.Request) {
	...
	data, _ := connection.Conn.Query(context.Background(), "SELECT name, description FROM tb_projects")
	...
	for data.Next() {
		...
		err := data.Scan(&each.NamaProject, &each.Description)
